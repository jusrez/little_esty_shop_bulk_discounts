...
RSpec.describe 'invoices show' do
  before :each do
    ...
    @discount_a = Discount.create!(percentage_discount: 10, quantity_threshold: 5, merchant_id: @merchant1.id)
    @discount_b = Discount.create!(percentage_discount: 15, quantity_threshold: 10, merchant_id: @merchant1.id)
  end
  ...
  it 'next to each invoice item I see a link to the show page for the bulk discount that was applied' do
    ...
    expect(current_path).to eq(merchant_discount_path(@merchant1, @discount_a))
  end
end
